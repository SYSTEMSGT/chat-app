  ...
  public function __construct() {
    ...
    if ($dh = opendir($this->localdir)) {
      ...
      if (!empty($this->zipfiles)) {
        $GLOBALS['status'] = array('info' => 'Archivos .zip or .gz o .rar encontrados, listo para la extracción.');
      }
      else {
        $GLOBALS['status'] = array('info' => 'Archivos .zip or .gz o rar no encontrados.');
      }
    }
  }
